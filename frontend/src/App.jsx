...
import DrProfile from "./components/DrProfile"; // ✅ Added DrProfile import
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* ✅ User/Doctor common Protected Routes */}
        <Route path="/doctor-dashboard" element={<ProtectedRoute><DoctorDashboard /></ProtectedRoute>} />
        <Route path="/dr-profile" element={<ProtectedRoute><DrProfile /></ProtectedRoute>} /> {/* ✅ Added DrProfile Route */}
